...
import { BlacklistAddresses } from 'src/constants/blacklist';
    ...
    <StakingPanelContainer>
      <StakingPanelWrapper>
        <StakingBalancePanel>
          ...
          <KingBalanceCircle>
            <KingBalanceTitle>$COS Balance</KingBalanceTitle>
            <KingBalanceValue>
        ...
        <StakingField>
          <KingPanel>
            <KingPanelTitle>Stake $COS</KingPanelTitle>
            <KingPanelAction>
              <KingPanelInput
                type="number"
                placeholder="Amount"
...
const StakingBalancePanel = styled.div`
  width: 336px;
  border-radius: 30px;
  background: #170b29 0% 0% no-repeat padding-box;
  display: flex;
  justify-content: center;
  align-items: center;
  flex-direction: column;
...
const KingPanelButton = styled.button`
  ...
  height: 57px;
  border: none;
  background: #8462f6 0% 0% no-repeat padding-box;
  border-radius: 29px;
  font-family: 'gotham-bold';
  opacity: ${(props) => (props.disabled ?? false ? 0.5 : 1)};
  @media screen and (max-width: 1024px) {
